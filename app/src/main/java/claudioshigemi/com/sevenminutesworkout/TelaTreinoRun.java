...
public class TelaTreinoRun extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minhaBarraProgresso = (ProgressBar) findViewById(R.id.meuProgressoBar);
        imagemEstrela = (ImageView)findViewById(R.id.imagemEstrela);
    ...
    public void proximoExercicio(){
        ...
        countDownTimer = new CountDownTimer(tempoExercicio*1000, 500) {
            @Override
            public void onTick(long millisUntilFinished) {
                atualizaLabelTempo((int) millisUntilFinished / 500);
            }
            @Override
    ...
    public void iniciaDescanso(){
        ...
        minhaBarraProgresso.setProgress(minhaBarraProgresso.getProgress() + 1);
        countDownTimer = new CountDownTimer(tempoExercicio*500, 500) {
            @Override
            public void onTick(long millisUntilFinished) {
                atualizaLabelTempo((int) millisUntilFinished / 500);
            }
    ...
    public void acabouTreino(){
        ...
        fundoTela.setBackgroundColor(Color.parseColor("#373737"));
        MediaPlayer somPlin = MediaPlayer.create(getApplicationContext(), R.raw.somplin);
        somPlin.start();
